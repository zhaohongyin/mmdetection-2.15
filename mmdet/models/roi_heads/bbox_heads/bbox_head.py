...
class BBoxHead(BaseModule):
    ...
    def get_bboxes(self,
        ...
        if self.custom_cls_channels:
            ...
            # zhy @1108 change for sigmoid test
            if 'use_sigmoid' in dir(self.loss_cls):
        ...
        # zhy: 'interclass' add for inter-class nms
        else:
            if 'interClass' in cfg.keys():
                if cfg.interClass:
                    det_bboxes, det_labels = interclass_nms(bboxes, scores,
